...
int32_t spiffs_hal_write(uint32_t addr, uint32_t size, uint8_t *src) {
    return (uint32_t)w25qxx_write_data(addr, src, size);
}
int32_t spiffs_hal_erase(uint32_t addr, uint32_t size) {
    return (uint32_t)w25qxx_sector_erase(addr);
}
int32_t spiffs_hal_read(uint32_t addr, uint32_t size, uint8_t *dst) {
    return (uint32_t)w25qxx_read_data(addr, dst, size, W25QXX_QUAD_FAST);
//    return (uint32_t)w25qxx_read_data(addr, dst, size, W25QXX_STANDARD);
}
